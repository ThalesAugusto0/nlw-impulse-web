...
interface FeedbackSeccessStepProps {
    onFeedbackRestartRequested: () => void;
}

export function FeedbackSeccessStep({ onFeedbackRestartRequested }: FeedbackSeccessStepProps) {
    return(
        <>
        <header>
            <CloseButton />
        ...
        <button
            ...
            className="py-2 px-6 mt-6 bg-zing-800 rounded-md
            border-transparent
            text-sm
            leading-6
            hover:bg-zing-700
